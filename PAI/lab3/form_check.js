...
function validate(formularz){;
    return (checkStringAndFocus(formularz.elements["f_imie"], "Podaj imie!", isWhiteSpaceOrEmpty) &&
    ...
    checkStringAndFocus(formularz.elements["f_ulica"], "Podaj ulica!", isWhiteSpaceOrEmpty) &&
